...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qstylizer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12339&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qstylizer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qstylizer` can be installed with:

```
conda install qstylizer
```

It is possible to list all of the versions of `qstylizer` available on your platform with:
